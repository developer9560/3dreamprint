...
export default function Home() {
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Custom Lithophane Lamps:<br />Transform Memories Into Light
            </h1>
            <p
  ...
  `
        ...
        {/* FAQ Section */}
        <section className="py-24 bg-black/40 backdrop-blur-md border-t border-white/10">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-12 text-center" style={{ textShadow: '0 0 20px rgba(255,193,7,0.5)' }}>
              Frequently Asked Questions
            </h2>
            <div className="space-y-6">
              {[
                {
                  q: "What is a Lithophane?",
                  a: "A lithophane is an etched or molded artwork in very thin translucent material that can only be seen clearly when back lit with a light source. At 3DreamPrint, we use high-precision 3D printing to create these beautiful pieces from your favorite photos."
                },
                {
                  q: "How do I choose the best photo for my lamp?",
                  a: "High-contrast photos with clear subjects work best. Avoid very dark or blurry images. Don't worry, our team checks every photo and will contact you if we need a better one to ensure your gift looks perfect."
                },
                {
                  q: "How long does delivery take?",
                  a: "Each custom lithophane is handcrafted with precision. Typically, it takes 5-7 business days for delivery across India. For special occasions like Valentine's Day, we recommend ordering early."
                },
                {
                  q: "Is the light source included?",
                  a: "Yes! All our lithophane lamps come with a high-quality LED light base and power adapter, ready to illuminate your memories right out of the box."
                }
              ].map((faq, idx) => (
                <div key={idx} className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors">
                  <h3 className="text-xl font-bold text-[var(--color-amber)] mb-3">{faq.q}</h3>
              ...
              dangerouslySetInnerHTML={{
                __html: JSON.stringify({
                  ...
                  "mainEntity": [
                    {
                      "@type": "Question",
                      "name": "What is a Lithophane?",
                      "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "A lithophane is an etched or molded artwork in very thin translucent material that can only be seen clearly when back lit with a light source."
                      }
                    },
                    {
                      "@type": "Question",
                      "name": "How do I choose the best photo for my lamp?",
                      "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "High-contrast photos with clear subjects work best. Avoid very dark or blurry images."
                      }
                    }
                  ]
                })
