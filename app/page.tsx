...
import ScrollImageSequence from '@/components/scroll/ScrollImageSequence';
  ...
  `
        ...
        <section className="min-h-screen flex items-center justify-center px-4">
          <div className="max-w-5xl mx-auto">
            <div className="backdrop-blur-xl bg-gradient-to-br from-pink-900/60 via-red-900/60 to-rose-900/60 p-12 md:p-16 rounded-3xl border-2 border-pink-300/30 shadow-2xl relative overflow-hidden">
              {/* Decorative hearts */}
              ...
              <div className="text-center relative z-10">
                <div className="inline-block mb-4">
                  <span
                    className="text-pink-200 text-sm md:text-base font-bold uppercase tracking-widest px-6 py-2 bg-pink-500/30 rounded-full border border-pink-300/50"
                    style={{
                ...
                <p
                  className="text-2xl md:text-3xl text-pink-100 font-semibold mb-8"
                  style={{
                ...
                <p
                  className="text-pink-200 text-sm mt-6 font-medium"
