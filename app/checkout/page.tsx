                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card padding="lg">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <Input label="Email" type="email" placeholder="john@example.com" fullWidth required className="md:col-span-2" />
                                <Input label="Phone" type="tel" placeholder="+91 98765 43210" fullWidth required className="md:col-span-2" />
                                <Input label="Address Line 1" placeholder="Street address" fullWidth required className="md:col-span-2" />
                                <Input label="Address Line 2" placeholder="Apartment, suite, etc. (optional)" fullWidth className="md:col-span-2" />
                                <Input label="City" placeholder="Mumbai" fullWidth required />
                                <Input label="State" placeholder="Maharashtra" fullWidth required />
                                <Input label="Postal Code" placeholder="400001" fullWidth required />
                            </div>
                        </Card>
